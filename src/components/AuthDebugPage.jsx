      ...
      <div className="auth-card" style={{ maxWidth: "800px" }}>
          ...
          {tokenDetails && (
            <div>
              ...
              {tokenDetails.error ? (
                ...
                <>
                  <p>
                    <strong>ID del usuario:</strong> {tokenDetails.payload.id}
                  </p>
                  <p>
                    <strong>Expiración:</strong>{" "}
                    {tokenDetails.expiration?.toLocaleString()}
                  </p>
                  <p>
                    <strong>Estado:</strong>{" "}
        ...
        <div style={{ marginTop: "20px" }}>
          ...
          <button
            ...
            style={{
              marginRight: "10px",
              opacity: !user || user.role !== "admin" ? 0.5 : 1,
            }}
          >
            Ir al Área de Admin
          </button>
        ...
        <div style={{ marginTop: "20px", textAlign: "left" }}>
          ...
          <ul>
            <li>
              Si no puede acceder a rutas protegidas, verifique que el token sea
              válido
            </li>
            <li>
              Si hay problemas de redirección, asegúrese de que el rol sea
              correcto:
              <ul>
            ...
            <li>
              Para arreglar problemas con el token, intente cerrar sesión y
              volver a iniciar sesión
            </li>
            <li>
              Si los problemas persisten, use el botón "Limpiar localStorage" e
              intente nuevamente
            </li>
          </ul>
        </div>
