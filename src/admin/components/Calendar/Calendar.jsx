    ...
    try {
      ...
      try {
        ...
        try {
          ...
          console.log("✅ Service updated via fallback:", updatedService);
        } catch (updateError) {
          console.error("❌ Both conversion and update failed:", updateError);
          // Si ambos fallan, crear un servicio mínimo para mantener la funcionalidad
          updatedService = {
            _id: realServiceId,
            status: "confirmed",
            technician: eventoCalendario.resourceId,
            ...
            scheduledEnd: scheduledEnd,
            serviceType:
              eventoCalendario.extendedProps?.serviceType || "Servicio",
            name: eventoCalendario.extendedProps?.clientName || "Cliente",
            description:
              eventoCalendario.extendedProps?.descripcion ||
              eventoCalendario.extendedProps?.description ||
              "",
          };
          console.log("⚡ Using fallback service object:", updatedService);
        }
      }
